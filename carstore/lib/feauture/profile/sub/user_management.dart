  ...
  if (currentUser != null) {
    return Scaffold(
      appBar: CustomAppBar(
        ...
        iconColor: appTheme.isDarkModeEnabled ? ColorConstants.primaryWhite:ColorConstants.primaryDark,
        onPressed: () {
        context.route.pop();
        },
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: _CustomStatTextfield(labelText:StringConstants.userManagementName, onPressed: () { 
            }, controller: _nameController,),
          ),
          
          Padding(
            padding: context.padding.normal,
            child: _CustomStatTextfield(labelText: StringConstants.userManagementBio, onPressed: () {  
...
class _CustomStatTextfield extends ConsumerWidget {
  const _CustomStatTextfield({required this.labelText, required this.onPressed, required this.controller} );
